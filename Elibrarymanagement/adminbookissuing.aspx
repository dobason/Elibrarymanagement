  ...
  <div class="container-fluid">
         ...
         <div class="col-md-6">
              <label>Book ID</label>
                ...
                <asp:TextBox CssClass="form-control" ID="TextBox3"
                    runat="server" placeholde="Book ID"  ></asp:TextBox> 
    ...
    <div class="row">
           ...
           <label>Book Name</label>
            ...
            runat="server" placeholde="Book Name" ReadOnly="True"></asp:TextBox>
          </div> 
    </div>  
    ...
    <div class="row">
             ...
             runat="server" placeholde="Start Date" TextMode="Date"></asp:TextBox>
              </div> 
            </div>    
           <div class="col-md-6">
         ...
         runat="server" placeholde="End Date" TextMode="Date"></asp:TextBox>
          </div> 
    </div>  
